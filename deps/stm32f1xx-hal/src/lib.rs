...
//!
//! This is an implementation of the [`embedded-hal`] traits for the STM32F1
...
//!
//! Follow the [cortex-m-quickstart] instructions, add this crate as a
//! dependency and make sure you enable the "rt" Cargo feature of this crate.
//! Also select which microcontroller you will be using by using the
//! corresponding feature. The currently supported microcontrollers are:
//!
//! - stm32f103
//! - stm32f100
//!
...
//! ## Usage example
//!
//! The following example blinks an LED connected to PC13 which is where the
//! LED is connected on the [blue_pill] board. If you are testing on a
//! different breakout board, you may need to change the pin accordingly.
//!
//!
//! ```rust
//! #![no_std]
